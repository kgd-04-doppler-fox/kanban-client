  ...
  methods: {
    login: function login() {
      ...
      (0, _axios.default)({
        ...
        //https://hidden-oasis-44746.herokuapp.com =>url heroku
        method: 'post',
        data: {
        ...
        _this.$emit('changePage', 'home-page');
      }).catch(function (err) {
        console.log(err.res);
      });
    },
...
exports.default = _default;
        var $f6b40f = exports.default || module.exports;
      
      if (typeof $f6b40f === 'function') {
        $f6b40f = $f6b40f.options;
      }
    
        /* template */
        Object.assign($f6b40f, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { attrs: { id: "login" } }, [
    _c(
      ...
      [
        ...
        _c("br"),
        _vm._v(" "),
        _c("a", { staticClass: "to-register" }, [
          _vm._v("Didnt have an account ?")
        ]),
        _vm._v(" "),
        _c(
          "a",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f6b40f', $f6b40f);
          } else {
            api.reload('$f6b40f', $f6b40f);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/HomePage.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    to_addTask: function to_addTask() {
      ...
      (0, _axios.default)({
        ...
        for (var i = 0; i < data.length; i++) {
          if (data[i].category === 'backlog') {
            _this.tasksBacklog.push(data[i]);
          } else if (data[i].category === 'todo') {
            _this.tasksToDo.push(data[i]);
          } else if (data[i].category === 'doing') {
            _this.tasksDoing.push(data[i]);
          } else if (data[i].category === 'done') {
            _this.tasksDone.push(data[i]);
          }
        }
      }).catch(function (err) {
        console.log(err);
    ...
    updateBacklog: function updateBacklog(id) {
      var _this2 = this;
      ...
      (0, _axios.default)({
        ...
        _this2.$emit('changePage', 'home-page');
    ...
    updateToDo: function updateToDo(id) {
      ...
      (0, _axios.default)({
        ...
        _this3.$emit('changePage', 'home-page');
    ...
    updateDoing: function updateDoing(id) {
      var _this4 = this;
      ...
      (0, _axios.default)({
        ...
        _this4.$emit('changePage', 'home-page');
    ...
    deleteTask: function deleteTask(id) {
      ...
      (0, _axios.default)({
        ...
        _this5.$emit('changePage', 'home-page');
...
exports.default = _default;
        var $649c7f = exports.default || module.exports;
      
      if (typeof $649c7f === 'function') {
        $649c7f = $649c7f.options;
      }
    
        /* template */
        Object.assign($649c7f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    _c("section", { staticClass: "content" }, [
      _c(
        ...
        [
          _vm._m(0),
          _vm._v(" "),
          _vm._l(_vm.tasksBacklog, function(task) {
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        return _vm.updateBacklog(task.id)
                      }
                    }
                  },
                  [_vm._v("Update")]
      ...
      _c(
        ...
        [
          _vm._m(1),
          _vm._v(" "),
          _vm._l(_vm.tasksToDo, function(task) {
            return _c("tr", { key: task.id }, [
              _c("td", [
                _vm._v(_vm._s(task.title)),
                _c("br"),
      ...
      _c(
        ...
        [
          _vm._m(2),
          _vm._v(" "),
          _vm._l(_vm.tasksDoing, function(task) {
            return _c("tr", { key: task.id }, [
              _c("td", [
                _vm._v(_vm._s(task.title)),
                _c("br"),
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        return _vm.updateDoing(task.id)
                      }
                    }
                  },
                  [_vm._v("Update")]
      ...
      _c(
        ...
        [
          _vm._m(3),
          _vm._v(" "),
          _vm._l(_vm.tasksDone, function(task) {
            return _c("tr", { key: task.id }, [
              _c("td", [
                _vm._v(_vm._s(task.title)),
                _c("br"),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("tr", [_c("th", { staticClass: "th1" }, [_vm._v("Backlog")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("tr", [_c("th", { staticClass: "th2" }, [_vm._v("To-Do")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("tr", [_c("th", { staticClass: "th3" }, [_vm._v("Doing")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("tr", [_c("th", { staticClass: "th4" }, [_vm._v("Done")])])
  }
]
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$649c7f', $649c7f);
          } else {
            api.reload('$649c7f', $649c7f);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/NewTask.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    new_task: function new_task() {
      ...
      (0, _axios.default)({
        ...
        _this.$emit('addNew', 'home-page');
      }).catch(function (err) {
        console.log(err);
      });
    },
    add_toHome: function add_toHome() {
      localStorage.removeItem('add_token');
...
exports.default = _default;
        var $0deac5 = exports.default || module.exports;
      
      if (typeof $0deac5 === 'function') {
        $0deac5 = $0deac5.options;
      }
    
        /* template */
        Object.assign($0deac5, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "new-task" } }, [
    _c(
      "form",
      {
        staticClass: "login-form",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0deac5', $0deac5);
          } else {
            api.reload('$0deac5', $0deac5);
          }
        }
  ...
  methods: {
    register: function register() {
      ...
      (0, _axios.default)({
        ...
        _this.$emit('successRegister', 'login-page');
      }).catch(function (err) {
        console.log(err);
      });
    },
...
exports.default = _default;
        var $e0b5b9 = exports.default || module.exports;
      
      if (typeof $e0b5b9 === 'function') {
        $e0b5b9 = $e0b5b9.options;
      }
    
        /* template */
        Object.assign($e0b5b9, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e0b5b9', $e0b5b9);
          } else {
            api.reload('$e0b5b9', $e0b5b9);
          }
        }
...
var _NewTask = _interopRequireDefault(require("./components/NewTask"));
...
exports.default = _default;
        var $8ce9ae = exports.default || module.exports;
      
      if (typeof $8ce9ae === 'function') {
        $8ce9ae = $8ce9ae.options;
      }
    
        /* template */
        Object.assign($8ce9ae, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.currentPage === "login-page"
        ...
        ? _c("RegisterForm", {
            on: {
              successRegister: _vm.changePage,
              cancelRegister: _vm.changePage
            }
          })
        : _vm.currentPage === "home-page"
        ? _c("HomePage", {
            on: { logoutSuccess: _vm.changePage, toNewTask: _vm.changePage }
          })
        : _c("NewTask", {
            on: { addNew: _vm.changePage, cancelCreate: _vm.changePage }
          })
    ],
    1
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$8ce9ae', $8ce9ae);
          } else {
            api.reload('$8ce9ae', $8ce9ae);
          }
        }
