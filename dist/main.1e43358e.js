...
var _default = {
  ...
  methods: {
    hapusTask: function hapusTask() {
      var _this = this;

      var answer = window.confirm("serius mau delete?");

      if (answer === true) {
        (0, _axios.default)({
          method: "DELETE",
          url: "https://tranquil-tundra-97414.herokuapp.com/tasks/".concat(this.task.id),
          headers: {
            access_token: localStorage.getItem("access_token")
          }
        }).then(function (response) {
          _this.$emit("fetchTask");
        }).catch(function (err) {
          var answer = window.confirm("maaf bukan punya anda");
    ...
    back: function back(category, id) {
      var _this2 = this;
      ...
      (0, _axios.default)({
        url: "https://tranquil-tundra-97414.herokuapp.com/tasks/".concat(id),
        method: "patch",
        data: {
    ...
    next: function next(category, id) {
      var _this3 = this;
...
exports.default = _default;
        var $b3ca8f = exports.default || module.exports;
      
      if (typeof $b3ca8f === 'function') {
        $b3ca8f = $b3ca8f.options;
      }
    
        /* template */
        Object.assign($b3ca8f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "card-body border border-4 pt-2 bg-light" }, [
    _c("p", { staticClass: "card-title font-weight-bold" }, [
      _vm._v(" " + _vm._s(_vm.task.title))
    ]),
    _vm._v(" "),
    _c("small", { staticClass: "text-muted" }, [
      _vm._v("author: " + _vm._s(_vm.task.User.username) + "\n      "),
      _c("br"),
      _vm._v(" "),
      _c("small", { staticClass: "text-muted" }, [
        _vm._v("email: " + _vm._s(_vm.task.User.email) + "\n      "),
        _c("br"),
        _vm._v(" "),
        _c("div", { staticClass: "btn btn-group ml-auto" }, [
                ...
                "svg",
                {
                  ...
                  on: {
                    click: function($event) {
                      ...
                      return _vm.back(_vm.task.category, _vm.task.id)
                    }
                  }
                },
                [
            ...
            ? _c(
                "svg",
                {
                  ...
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      return _vm.next(_vm.task.category, _vm.task.id)
                    }
                  }
                },
                [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b3ca8f', $b3ca8f);
          } else {
            api.reload('$b3ca8f', $b3ca8f);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/KanbanBoard.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $ad436d = exports.default || module.exports;
      
      if (typeof $ad436d === 'function') {
        $ad436d = $ad436d.options;
      }
    
        /* template */
        Object.assign($ad436d, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "col-3" }, [
    _c("div", { staticClass: "p-2 alert alert-info" }, [
      _c("h3", [_vm._v(_vm._s(_vm.categoryTitle))]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "overflow-auto", staticStyle: { height: "450px" } },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ad436d', $ad436d);
          } else {
            api.reload('$ad436d', $ad436d);
          }
        }
...
},{"./KanbanCard":"src/components/KanbanCard.vue","_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/MainPage.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $deff07 = exports.default || module.exports;
      
      if (typeof $deff07 === 'function') {
        $deff07 = $deff07.options;
      }
    
        /* template */
        Object.assign($deff07, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    _c(
      ...
      _vm._l(_vm.categories, function(category) {
        return _c("KanbanBoard", {
          key: category,
          attrs: { tasks: _vm.tasks, categoryTitle: category },
          on: { fetchTask: _vm.fetchTask }
        })
      }),
      1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$deff07', $deff07);
          } else {
            api.reload('$deff07', $deff07);
          }
        }
...
},{"./KanbanBoard":"src/components/KanbanBoard.vue","axios":"node_modules/axios/index.js","_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/vue-google-login/dist/vue-google-login.min.js":[function(require,module,exports) {
var define;
  ...
  methods: {
    login: function login() {
      ...
      (0, _axios.default)({
        ...
        _this.$emit("loginSucced", "dashboard");
...
exports.default = _default;
        var $f4064f = exports.default || module.exports;
      
      if (typeof $f4064f === 'function') {
        $f4064f = $f4064f.options;
      }
    
        /* template */
        Object.assign($f4064f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "btn btn-lg btn-dark btn-block text-uppercase bg-blue",
                    attrs: { type: "submit" }
                  },
                  [_vm._v("Login")]
                ),
                ...
                _c(
                  "a",
                  {
                    staticClass: "d-block mt-2 text-center text-dark",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f4064f', $f4064f);
          } else {
            api.reload('$f4064f', $f4064f);
          }
        }
...
var _default = {
  ...
  methods: {
    register: function register() {
      ...
      (0, _axios.default)({
        method: "POST",
        url: "https://tranquil-tundra-97414.herokuapp.com/register",
        data: {
...
exports.default = _default;
        var $56e380 = exports.default || module.exports;
      
      if (typeof $56e380 === 'function') {
        $56e380 = $56e380.options;
      }
    
        /* template */
        Object.assign($56e380, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
            ...
            _c(
              ...
              [
                _c("div", { staticClass: "form-label-group" }, [
                  ...
                  _vm._v(" "),
                  _c("label", { attrs: { for: "inputUserame" } }, [
                    _vm._v("name")
                  ])
                ]),
                _vm._v(" "),
                ...
                _c(
                  "button",
                  {
                    staticClass: "btn btn-lg btn-dark btn-block text-uppercase",
                    attrs: { type: "submit" }
                  },
                  [_vm._v("Register")]
                ),
                ...
                _c(
                  ...
                  [_vm._v("Already has an account? Login here")]
                ),
                _vm._v(" "),
                _c("hr", { staticClass: "my-4" })
              ]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$56e380', $56e380);
          } else {
            api.reload('$56e380', $56e380);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Navbar.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $a06dab = exports.default || module.exports;
      
      if (typeof $a06dab === 'function') {
        $a06dab = $a06dab.options;
      }
    
        /* template */
        Object.assign($a06dab, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "content" }, [
    _c("nav", { staticClass: "navbar navbar-expand-lg navbar-light bg-dark" }, [
      _c("h3", { staticClass: "text-white text-center" }, [_vm._v("Kanban")]),
      _vm._v(" "),
      _c(
        "button",
        {
          staticClass:
            "btn btn-outline-success ml-auto bg-dark my-2 my-sm-0 text-white",
          on: { click: _vm.logout }
        },
        [_vm._v("\n      Logout\n    ")]
      )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a06dab', $a06dab);
          } else {
            api.reload('$a06dab', $a06dab);
          }
        }
...
exports.default = _default;
        var $ffa2e7 = exports.default || module.exports;
      
      if (typeof $ffa2e7 === 'function') {
        $ffa2e7 = $ffa2e7.options;
      }
    
        /* template */
        Object.assign($ffa2e7, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.currentPage != "loginPage" && _vm.currentPage != "registerPage"
        ? _c("Navbar", {
            on: { changePage: _vm.changePage, logout: _vm.changePage }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.currentPage == "registerPage"
        ? _c("RegisterForm", {
            on: { backtologin: _vm.changePage, toLogin: _vm.changePage }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.currentPage == "loginPage"
        ? _c("LoginForm", {
            on: {
              loginSucced: _vm.changePage,
              changePage: _vm.changePage,
              afterLogin: _vm.fetchTask
            }
          })
        : _vm.currentPage == "dashboard"
        ? _c("MainPage", {
            attrs: { tasks: _vm.tasks, categories: _vm.categories },
            on: { changePage: _vm.changePage, fetchTask: _vm.fetchTask }
          })
        : _vm._e()
    ],
    1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ffa2e7', $ffa2e7);
          } else {
            api.reload('$ffa2e7', $ffa2e7);
          }
        }
...
},{"axios":"node_modules/axios/index.js","./components/MainPage":"src/components/MainPage.vue","./components/LoginForm":"src/components/LoginForm.vue","./components/RegisterForm":"src/components/RegisterForm.vue","./components/Navbar":"src/components/Navbar.vue","_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/vue-google-signin-button-directive/index.js":[function(require,module,exports) {
"use strict";
