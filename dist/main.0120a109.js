...
exports.default = _default;
        var $82529a = exports.default || module.exports;
      
      if (typeof $82529a === 'function') {
        $82529a = $82529a.options;
      }
    
        /* template */
        Object.assign($82529a, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    {
      staticClass: "shadow-lg p-3 mb-5 bg-white rounded",
      staticStyle: { width: "250px", margin: "auto", "margin-top": "60px" },
      attrs: { id: "start-page" }
    },
    [
      _c("h1", [_vm._v("Login")]),
      _vm._v(" "),
      _c("p", { style: { color: _vm.errorLogin } }, [
        _vm._v("email/password is wrong")
      ]),
      _vm._v(" "),
      _c(
        "form",
        ...
        [
          ...
          _c("input", {
            ...
            staticClass: "form-control form-control-sm form-control-block",
            attrs: { type: "email" },
            domProps: { value: _vm.email_login },
            on: {
              click: _vm.resetError,
          ...
          _vm._v(" "),
          _c("label", { staticClass: "mt-3", attrs: { for: "password" } }, [
            _vm._v("Password")
          ]),
          _vm._v(" "),
          _c("input", {
          ...
          _c(
            "button",
            { staticClass: "btn btn-primary btn-sm btn-block mt-3" },
            [_vm._v("Login")]
          )
        ]
      ),
      ...
      _c(
        ...
        [
          ...
          _c("a", { attrs: { href: "#" }, on: { click: _vm.signup } }, [
            _vm._v("Sign up")
          ]),
          _vm._v(" now")
        ]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$82529a', $82529a);
          } else {
            api.reload('$82529a', $82529a);
          }
        }
  ...
  methods: {
    registration: function registration() {
      ...
      (0, _axios.default)({
        ...
        _this.msg_inform = err;
        _this.color = 'red';
      });
      this.first_name = '', this.last_name = '', this.email_reg = '', this.password_reg = '';
    }
  },
  computed: {
...
exports.default = _default;
        var $ce717c = exports.default || module.exports;
      
      if (typeof $ce717c === 'function') {
        $ce717c = $ce717c.options;
      }
    
        /* template */
        Object.assign($ce717c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    {
      staticClass: "shadow-lg p-3 mb-5 bg-white rounded",
      staticStyle: { width: "250px", margin: "auto", "margin-top": "40px" },
      attrs: { id: "start-page" }
    },
    [
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("label", { staticClass: "mt-3", attrs: { for: "last_name" } }, [
            _vm._v("Last name")
          ]),
          _vm._v(" "),
          _c("input", {
          ...
          _vm._v(" "),
          _c("label", { staticClass: "mt-3", attrs: { for: "email-reg" } }, [
            _vm._v("Email")
          ]),
          _vm._v(" "),
          _c("input", {
          ...
          _vm._v(" "),
          _c("label", { staticClass: "mt-3", attrs: { for: "password-reg" } }, [
            _vm._v("password")
          ]),
          _vm._v(" "),
          _c("input", {
          ...
          _vm._v(" "),
          _c("button", { staticClass: "btn btn-primary btn-sm mt-3" }, [
            _vm._v("Submit")
          ])
        ]
      )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ce717c', $ce717c);
          } else {
            api.reload('$ce717c', $ce717c);
          }
        }
...
exports.default = _default;
        var $c7bd19 = exports.default || module.exports;
      
      if (typeof $c7bd19 === 'function') {
        $c7bd19 = $c7bd19.options;
      }
    
        /* template */
        Object.assign($c7bd19, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c7bd19', $c7bd19);
          } else {
            api.reload('$c7bd19', $c7bd19);
          }
        }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/main.js"], null)
//# sourceMappingURL=/main.0120a109.js.map