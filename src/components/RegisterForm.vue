            ...
            <div class="card-body">
              ...
              <form @submit.prevent="register" class="form-signin">
                <div class="form-label-group">
                  <input v-model="user.username" type="text" id="inputUserame" class="form-control" placeholder="Username" required autofocus>
                ...
                <button class="btn btn-lg btn-dark btn-block text-uppercase" type="submit">Register</button>
                  <a class="d-block mt-2 text-center text-dark" @click="toLogin">Already has an account? Login here</a>
                <hr class="my-4">
              </form>
            </div>
          </div>
...
<style scoped>
    ...
    .card-signin .card-img-left {
      ...
      background: scroll center url('https://www.kaggle.com/static/images/education/homepage-illustration.png');
